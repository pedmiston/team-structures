...
you can wear on your wrist, made by a company with over 120,000 employees that
is worth over one trillion dollars. Apple makes about 4 million of these every
quarter.
...
Groups as information processors.[^information]

[^search]: e.g., @Hong:2004gt; @Mason:2012jx; @Derex:2016hj
[^information]: @Hinsz:1997gh; @Woolley:2010ci
...
In general, there is a view in the group problem solving literature
that groups often perform differently than their parts. So for example,
in predicting how a group will do on a set of intelligence tests, it
isn't helpful to know the IQs of the individual members, but nonetheless
the performance of the group is highly correlated across tasks.
-->

# When does inheritance improve problem solving?

**Hard to answer!**

- Copying isn't always advantageous, but when it is, it's additive.
- Transmission experiments demonstrate _capacity_, not _effectiveness_.

<!--
Now let me ask a parallel question about the effects of inheritance on
problem solving.

When does inheriting from a previous generation improve problem solving?
...
inheritance in these models is in the best cases additive -- future generations
are able to pick up right where the previous generation left off.
...
Each strategy is allotted the same number of labor hours. This allows us
to measure the benefits of inheritance relative to the cost of creating it.
...
Just to give you a sense of the sample size, we collcted data for
at least 40 groups in each of the conditions, for a total of about 600
participants.
-->
...
In the Totem Game, participants are trying to discover tools
for the sake of building a sacred totem to appease the gods.
...
bots_team_size_plot + scale_x_discrete("Group size", labels = c("small", "large"))
```
...
- Cultural inheritance remediates the cost of fixation.
- Cultural inheritance scales better than group size.
